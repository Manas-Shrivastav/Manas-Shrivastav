...
**NLP & Text**
`NLTK` `KeyBERT` `spaCy` `Text Mining` `NER`

**Analytics & BI**
`Adobe Analytics` `Power BI` `Alteryx` `Snowflake`

**Cloud & Tools**
`Microsoft Azure (DP-300)` `Postman` `Selenium` `JIRA` `Confluence`
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Manas%20Shrivastav-0A66C2?style=flat&logo=linkedin)](https://linkedin.com/in/manas-shrivastav)
